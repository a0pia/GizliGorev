...
namespace HeneGames.Airplane
{
    ...
    public class SimpleAirPlaneController : MonoBehaviour
    {
        ...
        private void Crash()
        {
            ...
            //Kill player
            planeIsDead = true;
            skorUI.SetActive(false);
            ScriptPause.SetActive(false);
        ...
        private void HandleInputs()
        {
            ...
            //Turbo
            inputTurbo = Input.GetKey(KeyCode.LeftShift) || Input.GetKey(KeyCode.JoystickButton5);
